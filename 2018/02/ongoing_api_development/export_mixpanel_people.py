...
class Mixpanel(object):
    ...
    def request(self, params, output_filepath, format='json'):
...
if __name__ == '__main__':
    ...
    parameters = {}  # {'selector': '(properties["CloudWall ID"] >= 1)'}
    api.request(parameters, output_filepath="mixpanel_people.out")
    ...
    print
    "Here are the # of people %d" % global_total
    fname = "people_hiring_out.tmp"
    has_results = True
    total = 0
