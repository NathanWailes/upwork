...
class Mixpanel(object):
	...
	def request(self, methods, params, output_filepath):
		"""
...
api_key = '<<string>>'
api_secret = '<<string>>'
#event_array = raw_input("Events (array): ")
#from_date = raw_input("From Date: ")
#to_date = raw_input("To Date: ")
#where = raw_input("where (optional): ")

lastweek=date.today()-timedelta(days=2)
fromdate=str(lastweek)
thisday=date.today()
todate=str(thisday)
